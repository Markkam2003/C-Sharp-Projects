...
namespace DailyReportProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Ask for their name and display
            Console.WriteLine("What is your name?");
            string yourName = Console.ReadLine();
            Console.WriteLine("Your name is: " + yourName);

            // Ask for their course and display the course
            Console.WriteLine("What course are you on?");
            string yourCourse = Console.ReadLine();
            Console.WriteLine("Your course is: " + yourCourse);

            // Ask for their page number and display
            ...
            // Ask about feedback and display back value
            Console.WriteLine("Is there any other feedback you'd like to provide? Please be specific.");
            string otherFeedback = Console.ReadLine();
            Console.WriteLine("You answered: " + otherFeedback);

            //Ask how many hours were studied and display back
